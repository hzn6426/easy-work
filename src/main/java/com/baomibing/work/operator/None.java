...
public class None extends AbstractOperatorPredicate{

    public None(Object right) {
        this.right = right;
    }

    @Override
    public WorkReportJsonPredicate toWorkReportPredicate() {
        return () -> new JsonPredicate(left, OperatorEnum.none.name(),  right);
    }
    ...
    public boolean test(Object o) {
        ...
        return predicates.stream().noneMatch(p -> parse(p).apply((WorkReport) report));
    }
}
