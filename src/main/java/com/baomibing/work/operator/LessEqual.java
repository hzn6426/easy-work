...
public class LessEqual extends AbstractOperatorPredicate {

    public LessEqual(Object left, Object right) {
        this.left = left;
        this.right = right;
    }
    ...
    public WorkReportJsonPredicate toWorkReportPredicate() {
        return () -> new JsonPredicate(left, OperatorEnum.le.name(),  right);
    }
